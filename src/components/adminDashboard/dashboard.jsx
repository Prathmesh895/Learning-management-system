...
function Dashboard() {
  return (
    <div className=' lg:flex lg:flex-col lg:justify-between mx-2'>
      ...
      <div className='bg-white lg:h-96 my-4 p-4 rounded  '>
      ...
      <section className='bg-white my-4 flex flex-wrap divide-x-2'>
        <div className='lg:w-[25%] w-[50%] flex-wrap flex flex-col items-center justify-center py-6 space-y-3'>
          <TbStack2 className='text-gray-400' size={30} />
          <p className='font-bold text-xl'>0</p>
          <h1>Number of courses</h1>
        </div>
        <div className='lg:w-[25%] w-[50%] flex flex-col items-center justify-center py-6 space-y-3'>
          <MdPlayLesson size={25} className='text-gray-500' />
          <p className='font-bold text-xl'>0</p>
          <h1>Number of lessons</h1>
        </div>
        <div className='lg:w-[25%] w-[33%] flex flex-col items-center justify-center py-6 space-y-3'>
      ...
      <div className='flex space-x-5    lg:my-4 rounded'>
        <div className='lg:w-[33%]  p-5 mr-4 bg-white text-sm text-gray-500  '>
        ...
        <div className='lg:w-[66%] bg-white'>3</div>
      </div>
    </div>
  )
}
