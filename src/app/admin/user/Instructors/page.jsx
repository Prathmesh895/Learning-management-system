...
import Instructor from '@/app/instructorlist/page'
    ...
    <>
     <main className='lg:h-screen'>
      ...
      <h1 className="text-xl font-semibold ">Instructors</h1>
          <button onClick={Newinstructor} className="border border-gray-400 py-2 px-4 text-gray-800 hover:bg-gray-100 transition duration-300 ease-in-out">
            + Add Instructor
          </button>
      </div>
      <div> <Instructor/></div>
    ...
    <section className="absolute top-36 bg-white lg:mx-0 mx-2 shadow-2xl border border-gray-400 rounded ">
                {
                 ...
                 <button onClick={Newinstructor} className=" hover:bg-gray-200 font-bold py-2 px-36 border   mb-5">
                        Cancel
                    </button>
                 </div>
